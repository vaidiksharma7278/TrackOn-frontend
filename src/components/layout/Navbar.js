      ...
      <div className="flex items-center justify-between w-11/12 mx-auto lg:w-10/12 ">
        <div>
          <Link href="/">
            <a className="flex items-center gap-2">
              <img
                alt="metrack-logo"
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT9MKzSrnO1APuAwJXTKcoBWbeoGKLU851ueg&usqp=CAU"
                className="object-contain w-12 h-6"
              />
              <h1 className="hidden font-bold tracking-tight uppercase cursor-pointer lg:block">
                <span className="text-3xl text-secondary">Track</span>On
              </h1>
            </a>
          </Link>
        </div>
        {isAuth ? (
          <div className="flex items-center gap-4">
            <Link href={`/${user?._id}`}>
              <a className="text-xs font-bold border border-secondary-300 btn btn-ghost hover:bg-blue-50 btn-sm">
                Profile
              </a>
            </Link>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/auth/register">
              <button className="font-bold border border-secondary btn btn-ghost hover:bg-blue-50">
                Register
              </button>
            </Link>
          </div>
